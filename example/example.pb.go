...
type User struct {
	...
	ChainField    string                 `protobuf:"bytes,5,opt,name=chain_field,json=chainField,proto3" json:"chain_field,omitempty"`
...
func (x *User) GetChainField() string {
	if x != nil {
		return x.ChainField
	}
	return ""
...
const file_example_example_proto_rawDesc = "" +
	"\n" +
	"\x15example/example.proto\x12\aexample\x1a\x1bproto/sdm/annotations.proto\"\x97\x01\n" +
	"\x04User\x12\x14\n" +
	"\x02id\x18\x01 \x01(\tB\x04\x80\xb5\x18\x01R\x02id\x12\x18\n" +
	"\x04name\x18\x02 \x01(\tB\x04\x90\xb5\x18\x01R\x04name\x12\x1e\n" +
	"\x05email\x18\x03 \x01(\tB\b\x90\xb5\x18\x01\xa0\xb5\x18\x01R\x05email\x12\x1e\n" +
	"\aaddress\x18\x04 \x01(\tB\x04\x88\xb5\x18\x01R\aaddress\x12\x1f\n" +
	"\vchain_field\x18\x05 \x01(\tR\n" +
	"chainFieldB'Z%github.com/jinuthankachan/sdm/exampleb\x06proto3"
